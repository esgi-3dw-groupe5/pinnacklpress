<div id="main">
    ...
    <!-- <section> -->
        <div class="content">
            <form  class="pinnackl-form" action="" method="post">
                <legend><h1>{{legend}}</h1></legend>
                <fieldset class="pinnackl-group">
                    <input id="{{input_1}}" name="{{input_1}}" type="{{type_1}}"
                                            class="pinnackl-input-1-2" placeholder="{{label_1}}">
                    
                    <input id="{{input_2}}" name="{{input_2}}" type="{{type_2}}"
                                            class="pinnackl-input-1-2" placeholder="{{label_2}}">
