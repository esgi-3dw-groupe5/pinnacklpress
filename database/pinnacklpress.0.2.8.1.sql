...
--
-- Structure de la table `pp_category`
--
...
--
-- Contenu de la table `pp_category`
--

INSERT INTO `pp_category` (`category_id`, `category_name`) VALUES
(2, 'test'),
(3, 'Musique');
...
--
-- Structure de la table `pp_category_rs`
--

CREATE TABLE IF NOT EXISTS `pp_category_rs` (
...
(5, 'pseudo', 'text', 'pseudo', 'text', '', ''),
(6, 'firstname', 'text', 'firstname', 'text', '', ''),
(7, 'lastname', 'text', 'lastname', 'text', '', ''),
(8, 'date', 'date', 'date', 'date', '', ''),
(9, 'email', 'email', 'email', 'email', '', ''),
(10, 'password', 'password', 'password', 'password', '', '');
...
INSERT INTO `pp_page` (`page_id`, `page_tag`, `page_name`, `page_connectedAs`, `page_type`, `page_status`, `page_comment_status`, `page_author`, `page_date`, `page_udate`, `page_comment_count`, `page_order`, `page_parent`) VALUES
(14, 'condition-general-d-utilisation', 'Condition g̩n̩ral d''utilisation', 'visitor', 'page', 'publish', 'enable', 0, '2015-05-23 03:39:30', '2015-06-21 17:54:19', 0, 9, 0),
(15, 'inscription', 'Inscription', 'visitor', 'page', 'publish', 'enable', 0, '2015-05-22 23:33:28', '2015-07-01 22:05:27', 0, 3, 0),
(16, 'term-of-use', 'Term of use', 'visitor', 'page', 'publish', 'enable', 0, '2015-05-22 23:33:28', '2015-06-21 18:10:51', 0, 2, 0),
(18, 'test-page', 'Test Page', 'member', 'category', 'publish', 'enable', NULL, '2015-05-23 13:54:28', '2015-05-24 01:10:11', NULL, 4, NULL),
(19, 'index', 'Index', 'visitor', 'page', 'publish', 'enable', NULL, '2015-05-23 15:17:57', '2015-06-10 14:47:52', NULL, 1, NULL),
(20, 'mon-premier-article', 'Mon premier article', 'visitor', 'post', 'publish', 'enable', NULL, '2015-05-23 20:20:09', '2015-06-23 02:37:26', 0, 10, 0),
(21, 'undefine', 'Undefine', 'visitor', 'category', 'publish', 'enable', 0, '2015-05-25 19:21:27', '2015-06-21 18:18:50', 0, 2, 0),
(22, 'footer', 'footer', 'visitor', 'footer', 'publish', NULL, NULL, '2015-07-01 15:09:08', '2015-07-01 15:14:39', NULL, NULL, NULL),
(23, 'connection', 'connection', 'visitor', 'page', 'publish', 'enable', NULL, '2015-07-01 23:32:05', '2015-07-01 23:33:26', NULL, 4, NULL);
...
(79, 22, 'footer', '[{"line":[{"gridClass":"grid-4_4","gridModule":"[text]","gridContent":"Lorem Ipsum"}]}]'),
(80, 15, 'content', '[{"line":[{"gridClass":"grid-4_4","gridModule":"[form]","gridContent":"inscription"}]}]'),
(81, 23, 'content', '[{"line":[{"gridClass":"grid-4_4","gridModule":"[form]","gridContent":"connection"}]}]');
